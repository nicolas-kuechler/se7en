...
public class GirGuiceServletContextListener extends GuiceServletContextListener {
	...
	private Properties getProperties() {
		...
		if (SystemProperty.environment.value() == SystemProperty.Environment.Value.Production) {
			...
			properties.put("javax.persistence.jdbc.url", "jdbc:google:mysql://se-team-se7en:db/se7en_v3");
			properties.put("javax.persistence.jdbc.user", "root");
			properties.put("javax.persistence.jdbc.password", "");
		} else {
			// local development environment
			properties.put("javax.persistence.jdbc.driver", "com.google.appengine.api.rdbms.AppEngineDriver");
			properties.put("javax.persistence.jdbc.url", "jdbc:google:rdbms://173.194.250.0/se7en_v3");

...
public class MapPresenterTest {
	...
	public void setup()
	{
		...
		//filling the years array with 1 production in the first year, 2 in the second, 3 in the third...
		...
		//c1 has no film productions -> empty array -> c1 should not be in the entities array
		...
		//when the method getCountryList of the mock is called, then the predefined list countries is returned
		when(filmDataModel.getCountryList()).thenReturn(countries);
		
		//because mapView is a mock
		//when the method getMinYear or getMaxYear of the mock is called return the sepcified years.
	...
	{
		//Test that when the range slider is changed, the geochart & the filmdata model is updated
		mapPresenter.onRangeSliderChanged();
		//Three times because updateGeoChart is called 2 times in the constructor
	...
	{
		//Test that when the method updateGeoChart is called, the geochart & the filmdata model is updated
